...
def convert_id_to_task_name(task_id: int):
    print('Raw path:', nnUNet_raw_data, 'task id', task_id)
    print('preproc output dir:', preprocessing_output_dir)
    print('Cropped dir:', nnUNet_cropped_data)
    print('Training out dir:', network_training_output_dir)
    ...
    if nnUNet_raw_data is not None:
        ...
        candidates_raw = []
    print('Candidates raw:', candidates_raw)
